...
public enum ErrorCode {
    ...
    USERNAME_NOT_VALID("Username must be at least {min} characters", 400),
    PASSWORD_NOT_VALID("Password must be at least {min} characters", 400),
    ...
    INVALID_BIRTH("Birth must be more than {min}", 400),
